/*
    File:           AddSensorDialogFragment.java
    ...
    Description:    This class controls items on the dialog fragment for Admins to add a sensor to a
                    Room.
*/
...
public class AddSensorDialogFragment extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.dialogfragment_add_sensor, container, false);
